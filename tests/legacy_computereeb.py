"""Frozen copy of the previous computeReeb implementation (cereeberus 0.1.20).

Used only as a reference in tests/test_computereeb.py. Not part of the package.
"""
...
def get_levelset_components(L):
    """
    Given a list of simplices L representing a level set, compute the connected components. This function is really only helpful inside of computeReeb_legacy.
...
def computeReeb_legacy(K: LowerStar, verbose=False):
